...
namespace ColorfulSoft.DeOldify
{
  ...
  public sealed class MainForm : Form
  {
    ...
    /// <summary>
    /// Dow we add the extra text to the file name on save.
    /// </summary>
    private CheckBox __AddToFileName;
    private bool _addToFileName = false;
    ...
    private Boolean SaveImage(Boolean saveas = false) {
      ...
      if (!String.IsNullOrEmpty(__ImageFileName)) {
        ...
        destFileName = Path.GetFileNameWithoutExtension(__ImageFileName);
        if (_addToFileName) {
          destFileName += "-deoldified";
        }
      }
    ...
    public MainForm() : base() {
      ...
      try {
        ...
        this.Height = 800; // (int)(Screen.FromControl(this).Bounds.Height * 0.7);
        this.Width = 800; // (int)(this.Height * 1.2); //proportions closer to 3:2 and 4:3
        ...
        this.__ButtonLoad.Text = "Reload image";
        ...
        this.__StartButton.Font = new Font(__StartButton.Font.Name, __StartButton.Font.Size, FontStyle.Bold);
        this.__StartButton.NotifyDefault(true);
        this.__StartButton.Size = __ScaleDPI(new Size(100, 25));
        ...
        this.__DecolorizeButton.Font = new Font(this.Font.Name, this.Font.Size, FontStyle.Bold);
        this.__DecolorizeButton.Size = __ScaleDPI(new Size(100, 25));
        ...
        this.__AddToFileName = new CheckBox();
        this.__AddToFileName.Checked = _addToFileName;
        this.__AddToFileName.Text = "+deoldify";
        this.__AddToFileName.Size = __ScaleDPI(new Size(80, 25));
        this.__AddToFileName.Location = new Point(this.__DecolorizeButton.Left - __ScaleDPI(10) - this.__AddToFileName.Width, this.__StartButton.Top);
        this.__AddToFileName.Anchor = (AnchorStyles.Top | AnchorStyles.Right);
        this.__FooterPanel.Controls.Add(this.__AddToFileName);

        this.__ButtonSave = new Button();
        if (this._addToFileName) {
          this.__ButtonSave.Text = "Save + deoldify";
        }
        else {
          this.__ButtonSave.Text = "Save";
        }
        this.__ButtonSave.Font = new Font(this.Font.Name, this.Font.Size, FontStyle.Bold);
        this.__ButtonSave.Size = __ScaleDPI(new Size(100, 25));
        this.__ButtonSave.Location = new Point(this.__AddToFileName.Left - __ScaleDPI(10) - this.__ButtonSave.Width, this.__StartButton.Top);
        ...
        toolTipSave.AutoPopDelay = 5000;
        toolTipSave.InitialDelay = 1000;
        toolTipSave.ReshowDelay = 500;
        toolTipSave.ShowAlways = true;
        toolTipSave.SetToolTip(this.__ButtonSave, "Save the image");
        toolTipSave.SetToolTip(this.__AddToFileName, "Do we add deoldify to file name");
        toolTipSave.SetToolTip(this.__DecolorizeButton, "Remove colour from picture");
        ...
        ////////////////////////////////////////////////////////////////////////////////
        // Events
        this.__AddToFileName.CheckedChanged += delegate
        {
          this._addToFileName = !this._addToFileName;
          if (this._addToFileName) {
            this.__ButtonSave.Text = "Save + deoldify";
          }
          else {
